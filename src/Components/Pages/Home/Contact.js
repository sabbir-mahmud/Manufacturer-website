        ...
        <div className="hero min-h-screen">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <div className="lg:w-2/4 lg:ml-24 text-center lg:text-left">
                    ...
                    <p className="py-6">
                        confused to start your new business. contact with our
                        specialist team to get a high-level business talk. just
                        fill out the form our team will contact you as soon as
                        possible.
                    </p>
                </div>
